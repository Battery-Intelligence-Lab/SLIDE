...
| 2026-07-10 | Phase 9B bug ledger | IN PROGRESS — P9-B01..B28 additionally close Mode-C/pack-solver, PackStepper/thermal transaction, public byte-shuffle, compiled-curve, Experiment-resource, and BPX grammar/allocation defects. Current full Debug/Release subsystem gates: Experiment 199, ParameterSet 1,495, parser allocation 906, Recorder 98, AsyncRecorder 238, async allocation 15, PackTopology 66, PackSolver 667, PackStepper 172, P2-G1 allocation 6, ModeC 52, CompiledCurve 163, ThermalLumped 25 assertions. Ledger and refutations: `.claude/reports/p9b-bug-ledger-2026-07-10.md`. |
