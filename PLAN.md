...
| — | Phases 1–8 | Phase 1 IN PROGRESS (DONE: StateArena/BatchBuilder + tests, P1-G0 pilot + Release re-confirm. NEXT: production `SpectralDiffusion<NCH>`, ThermalLumped, ageing kernels, registry, P1-G1..G3); Phases 2–8 not started |
