...
| 2026-07-10 | Phase 9B bug ledger | IN PROGRESS — P9-B01..B05 fix Cycler event transactions plus synchronous recorder ordering, derived-value, and enum validation. Pre-fix registered tests fail as expected; post-fix full Experiment and Recorder binaries pass 183/183 and 98/98 respectively in Debug/Release. Ledger and refutations: `.claude/reports/p9b-bug-ledger-2026-07-10.md`. |
