...
observable stage, `ThermalLumped` with arena-owned heat/time accumulators, SEI ageing mechanisms 1–4 with
porosity coupling, and shared Dai/Laresgoiti stress observables with explicit previous-step arena state. NOT
STARTED: the rest of the Deliver list — crack/LAM/plating ageing kernels, registry + factory,
