...
| 2026-07-10 | Phase 9B bug ledger | IN PROGRESS — P9-B01/B02 fix Cycler metadata/unit-conversion validation and complete event-trial arena rollback. Pre-fix `[P9]` produced 13 assertion failures; post-fix full Experiment Debug/Release binaries each pass 183/183. Ledger and refutations: `.claude/reports/p9b-bug-ledger-2026-07-10.md`. |
