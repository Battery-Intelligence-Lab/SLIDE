...
| 2026-07-10 | Phase 9B bug ledger | IN PROGRESS — P9-B01..B10 fix Cycler transactions and sync/async recorder validation, ordering, allocation bounds, wire discriminants, and configure rollback. Pre-fix registered tests fail as expected; post-fix full Experiment, Recorder, AsyncRecorder, and async allocation binaries pass 183/183, 98/98, 233/233, and 15/15 respectively in Debug/Release. Ledger and refutations: `.claude/reports/p9b-bug-ledger-2026-07-10.md`. |
