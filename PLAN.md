...
| 2026-07-10 | Phase 9B bug ledger | IN PROGRESS — P9-B01..B09 fix Cycler transactions and sync/async recorder validation, ordering, allocation bounds, and wire discriminants. Pre-fix registered tests fail as expected; post-fix full Experiment, Recorder, and AsyncRecorder binaries pass 183/183, 98/98, and 233/233 respectively in Debug/Release. Ledger and refutations: `.claude/reports/p9b-bug-ledger-2026-07-10.md`. |
