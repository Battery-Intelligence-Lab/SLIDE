...
mechanisms 1–5, porosity/diffusivity coupling, and shared Dai/Laresgoiti stress observables with explicit
previous-step arena state. NOT
STARTED: the rest of the Deliver list — LAM/plating ageing kernels, registry + factory,
