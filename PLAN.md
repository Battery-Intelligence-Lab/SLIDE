...
> **Status:** ACTIVE. Last updated 2026-07-10 (Phase 9B P9-G2 passed). Phases 0–8 and 9A COMPLETE;
...
| 2026-07-10 | Phase 9B bug ledger | IN PROGRESS — P9-B01..B29 close Mode-C/pack-solver, PackStepper/thermal transaction, recorder, public byte-shuffle, compiled-curve, Experiment/BPX parser, and allocation defects. The bounded liionpack CSV importer and shared electrical finalizer are implemented. **P9-G2 is PASSED:** isolated Debug/Release ASan+UBSan fuzz targets, independent/poisoned atomicity oracles, corpora/dictionaries, limit replays, mutation checks, and the two-job CI workflow are complete; Linux 60-second campaign counts are 149,399/73,981/94,933 Debug and 291,223/546,881/556,946 Release. P9-G1/G3/G4 remain open. Current full Debug/Release subsystem gates: Experiment 203, ParameterSet 1,495, netlist CSV 728, parser allocation 913, Recorder 98, AsyncRecorder 238, async allocation 15, PackTopology 66, PackSolver 667, PackStepper 172, P2-G1 allocation 6, ModeC 52, CompiledCurve 163, ThermalLumped 25 assertions. Ledger and refutations: `.claude/reports/p9b-bug-ledger-2026-07-10.md`. |
