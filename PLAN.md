...
(12 entries: nch={5,8,12} × isothermal/thermal × base/ageing-capable). NOT STARTED: the `Simulation` façade — and
gates P1-G1/G2/G4.
...
§2.1 correction) — **DONE 2026-07-10** → (5) registry/factory — **DONE 2026-07-10** → façade + `EulerLegacy` stepper → P1-G1/G2/G4 → PAY-1. The three
