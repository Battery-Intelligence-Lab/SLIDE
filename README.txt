...
Download a .zip file of the code at: [LINKLINK][5]
...
```
git clone LINK TO GITHUB GIT    ( https://github.com/adrienBizeray/Spectral_li-ion_SPM.git)
```
