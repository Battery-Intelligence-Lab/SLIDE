...
namespace slide
{
	...
	Cell_user::Cell_user(const slide::Model &MM, int verbosei)
	 ...
	 */
		...
		// Stress parameters
		sparam = settings::def_param::StressParam_User;
		...
		seiparam = settings::def_param::SEIparam_User;
		...
		OCVnmc = 4.1;
		// fitting parameters
		lamparam = settings::def_param::LAMparam_User;
	...
	Cell_user::Cell_user(const slide::Model &M, const DEG_ID &degid, int verbosei) : Cell_user(M, verbosei)
	{
		/*
