...
{
public:
	Cell_Fit(const struct slide::Model &, int verbosei); // standard constructor

	void setOCVcurve(std::string namepos, std::string nameneg);														  // sets the OCV curve of the cell to the given value
