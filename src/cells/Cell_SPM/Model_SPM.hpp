...
struct Model_SPM
{
  ...
  Model_SPM()
  {
    ...
    // RESOLVED(2026-07-10): the v4 per-batch compiler in core/SpectralModel.hpp Status-checks
    // eigensolver success, complex contamination, invertibility, the mass mode, and the registered
    // analytic tan(mu)=mu spectrum. Legacy behaviour remains unchanged per PLAN §5.1.
