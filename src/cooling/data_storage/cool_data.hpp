...
namespace slide
{
    ...
    using CoolSystemData_t =
        std::conditional_t<settings::DATASTORE_COOL == 1, CoolSystemHist_t,
                           std::conditional_t<settings::DATASTORE_COOL == 2,
                                              CoolSystemInst_t, Empty>>;
    //-------------------------------------------------------------------------
    ...
    using CoolSystem_HVACData_t =
        std::conditional_t<settings::DATASTORE_COOL == 1, CoolSystem_HVACHist_t,
                           std::conditional_t<settings::DATASTORE_COOL == 2,
                                              CoolSystem_HVACInst_t, Empty>>;
