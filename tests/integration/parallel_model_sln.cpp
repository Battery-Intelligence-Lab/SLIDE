...
Eigen::VectorXd parallel_model_dae5(double t, const Eigen::VectorXd &x, double I, const Eigen::MatrixXd &A11, const Eigen::MatrixXd &A12, const Eigen::MatrixXd &A21, const Eigen::MatrixXd &A22, const std::vector<double> &ocv_coefs, const Eigen::VectorXd &R, const Eigen::VectorXd &r, Eigen::VectorXd &xdot) {
    int n = x.size() / 2;
    Eigen::VectorXd SOC(n), OCV_branch(n), w(n), v_mod(n);
